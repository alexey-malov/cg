...
const TCHAR WINDOW_TITLE[] = "Particle system";				// The title bar text
...
bool OnCreate(HWND hWnd)
{
	...
	if (InitOpenGL(hWnd))
	{
		...
		if (
			(g_particleTexture = LoadTextureFromRgbBitmapFile("particle.bmp")) &&
			(g_floorTexture = LoadTextureFromRgbBitmapFile("floor.bmp"))
			)
		{
			return true;
		}
